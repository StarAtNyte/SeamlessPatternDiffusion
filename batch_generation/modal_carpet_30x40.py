...
app = modal.App("carpet-30x40-generator", image=image)

# Model configuration
MODEL_ID = "black-forest-labs/FLUX.1-dev"
DTYPE = torch.bfloat16

# Volume for storing generated images - 30x40 specific
output_volume = modal.Volume.from_name("generated-carpet-30x40", create_if_missing=True)

# Target and generation resolutions
TARGET_WIDTH = 30
TARGET_HEIGHT = 40
GEN_WIDTH = 32  # 16-divisible
GEN_HEIGHT = 48  # 16-divisible
...
def generate_carpet_dataset_30x40():
  ...
  "Traditional_Rug": [
    ...
    config = {
        "output_folder": "/data/generated_carpets_30x40",
    ...
    print(f"Starting 30x40 carpet generation for {total_classes} classes")
    ...
    # Process single resolution (30x40)
...
if __name__ == "__main__":
    # Local execution
    with app.run():
        generate_carpet_dataset_30x40.remote()