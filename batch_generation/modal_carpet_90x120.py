...
app = modal.App("carpet-90x120-generator", image=image)

# Model configuration
MODEL_ID = "black-forest-labs/FLUX.1-dev"
DTYPE = torch.bfloat16

# Volume for storing generated images - 90x120 specific
output_volume = modal.Volume.from_name("generated-carpet-90x120", create_if_missing=True)

# Target and generation resolutions
TARGET_WIDTH = 90
TARGET_HEIGHT = 120
GEN_WIDTH = 96  # 16-divisible
GEN_HEIGHT = 128  # 16-divisible
...
def generate_carpet_dataset_90x120():
  ...
  "Traditional_Rug": [
    ...
    config = {
        "output_folder": "/data/generated_carpets_90x120",
    ...
    print(f"Starting 90x120 carpet generation for {total_classes} classes")
    ...
    # Process single resolution (90x120)
...
if __name__ == "__main__":
    # Local execution
    with app.run():
        generate_carpet_dataset_90x120.remote()